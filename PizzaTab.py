import sys 
from PyQt6.QtWidgets import QWidget, QLabel, QRadioButton, QPushButton, QHBoxLayout, QVBoxLayout, QButtonGroup
...
class PizzaTab(QWidget):
    ...
    def buildPizzaLayout(self):
        ...
        pizza_paragraph = QLabel("<p Build a custom pizza for you. Start with your favorite crust and add any toppings, plus the perfect amount of cheese and sauce. </p>")
        
        build_pizza_h_box.addWidget(pizza_img)
        build_pizza_h_box.addWidget(pizza_paragraph)
